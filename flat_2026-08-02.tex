...
All strong laws in the main part of this article build upon \cite[Theorem 8.2]{korf01} -- a deep convergence result for functions $\MS \to \R$. In appendix \ref{sec:alt}, we show a different route to a strong law in one-sided Hausdorff distance. This is illustrative, but requires slightly stricter assumptions. 
...
In contrast to the arguments in the main part of the article, it does not rely on the powerful result \cite[Theorem 8.2]{korf01}, which seems to be rather complex to prove. Instead our reasoning here is simpler and more self-contained.
...
\begin{theorem}\label{thm:alt:convOfMini}
	...
	\end{equation*}
\end{theorem}
\begin{remark}\label{rem:alt:nonempty}
